# Íconos de instalación, manifiesto y service worker para que sea PWA

# Agregar notificación al marcar como desbloqueado

this is the manigfest created:

{
    "name": "Fallout 76 Legendary Tracker",
    "short_name": "Fo76 Legendaries",
